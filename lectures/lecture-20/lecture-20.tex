  ...
  \begin{darkframes}
   ...
   %{slide 10}
    ...
    \begin{frame}[fragile]{Rollback Procedure}
      ...
      \text{15 is the maximum out of of 10, 13, and 15}
    ...
    %{slide 13}
    \begin{frame}[fragile]{Sally Ann Sole's decision tree}
    \fontsize{10}{10}\selectfont  
      \begin{center}
    ...
    %{slide 14}
    \begin{frame}[fragile]{Sally Ann Soles' Shoe Factory With A Second Decision}
     \fontsize{10}{10}\selectfont  
     ...
     \text{2M in profit if the economy is good, but 1M if it is bad, (b) abandon} 
     \text{the project and sell the equipment she original bought for 1.3M, or}
     \text{(c) do nothing.} 
    ...
    \begin{frame}[fragile]{EV of the Project}
        ...
        \text{       the new EV - the old EV = 2.48M - 2.1M = 380,000 USD} 
    \end{frame}
   ...
   %{slide 17}
    ...
    \fontsize{10}{10}\selectfont  
       \text{This method of valuing a real option is used by corpotate strategists,}
       \text{management consultants, and bankers. A further refinement is to take}
       \text{time value of money into account and present value everything.}
