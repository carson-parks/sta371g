...
\options{5/16/17}{\noclassday}
\options{5/18/17}{\noclassday}
\caltext{5/12/17}{Final exam 2PM class\\(9 AM-12 PM)}
\caltext{5/15/17}{Final exam 12:30PM class\\(2 PM-5 PM)}


\caltext{1/17/17}{Introduction to analytics}
\caltext{1/19/17}{Review of distributions and estimation}
\caltext{1/31/17}{Simple regression}
\caltext{2/7/17}{Multiple regression}
\caltext{2/14/17}{Dummy variables}
\caltext{2/16/17}{Interactions}
\options{2/23/17}{\noclassday}
\caltext{2/23/17}{Midterm 1}


\caltext{2/28/17}{Diagnostics and transformations}
\caltext{3/7/17}{Model selection}
\caltext{3/9/17}{Logistic regression}
\caltext{3/23/17}{Autoregression}
\caltext{3/28/17}{Moving averages and smoothing}


\options{3/30/17}{\noclassday}
\caltext{3/30/17}{Midterm 2}
\caltext{4/4/17}{Decision trees}
\caltext{4/2017}{Simulation}
